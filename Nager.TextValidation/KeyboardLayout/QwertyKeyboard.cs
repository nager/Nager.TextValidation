...
namespace Nager.TextValidation.KeyboardLayout
{
    public class QwertyKeyboard : IKeyboard
    {
        ...
        public IDictionary<char, Position> GetCharPositions()
        {
            ...
            keyboard.Add('a', new Position(1.3, 3));
            ...
            keyboard.Add('w', new Position(2, 4));
            keyboard.Add('x', new Position(2.8, 2));
            keyboard.Add('y', new Position(6, 4));
            keyboard.Add('z', new Position(1.8, 2));
            keyboard.Add(';', new Position(10.3, 3));
